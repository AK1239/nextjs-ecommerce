        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCobra believe that a phone case doesnt only need to look good, but also last
              you for the years to come. We offer a 5-year print guar antee: If your case isnt of
              the highest quality, we'll replace it for free.
            </p>
          </div>
        </div>
