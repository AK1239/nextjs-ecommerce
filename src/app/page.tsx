    ...
    <div className="bg-slate-50">
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "This case feels durable and I even got a compliment on the design. Had the case
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  pretty heavy scratchmarks on all of my last phone cases. This one, besides a
      ...
      <MaxWidthWrapper className="py-24">
        ...
        <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
          ...
          <li className="w-fit">
            <Check className="h-5 w-5 inline mr-1.5 text-green-600" />5 year print warranty
          </li>
